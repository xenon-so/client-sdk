...
exports.getSolendReserveByAddress = exports.SOLEND_RESERVES = exports.mainnet_reserves = exports.SOLEND_DERIEVED_MARKET = exports.SOLEND_MARKET = void 0;
var web3_js_1 = require("@solana/web3.js");
var isMainnet_1 = require("../isMainnet");
var tokens_1 = require("./tokens");
exports.SOLEND_MARKET = new web3_js_1.PublicKey(isMainnet_1.isMainnet
    ? '4UpD2fh7xH3VP9QQaXtsS1YY3bxzWhtfpks7FatyKvdY'
    : '6fafHRaToKecERFCx8mAwCBnCKYHktw3nATQp8a8J1Mx');
exports.SOLEND_DERIEVED_MARKET = new web3_js_1.PublicKey(isMainnet_1.isMainnet
...
exports.mainnet_reserves = {
    USDT: {
        mint: tokens_1.mainnetTokens.USDT.mintAddress,
    ...
    USDC: {
        mint: tokens_1.mainnetTokens.USDC.mintAddress,
    ...
    SOL: {
        mint: tokens_1.mainnetTokens.WSOL.mintAddress,
        address: '8PbodeaosQP19SjYFx855UMqWxH2HynZLdBXmsrbac36',
        collateralMintAddress: '5h6ssFpeDeRbzsEHDbTQNH7nVGgsKrZydxdSTnLm6QdV',
        collateralSupplyAddress: 'B1ATuYXNkacjjJS78MAmqu8Lu8PvEPt51u4oBasH1m1g',
        liquidityAddress: '8UviNr47S8eL6J3WfDxMRa3hvLta1VDJwNWqsDgtN3Cv',
    ...
    mSOL: {
        mint: tokens_1.mainnetTokens.mSOL.mintAddress,
...
exports.SOLEND_RESERVES = isMainnet_1.isMainnet
    ? exports.mainnet_reserves
    : devnet_reserves;
var getSolendReserveByAddress = function (address) {
    var key = Object.keys(exports.SOLEND_RESERVES).find(function (f) { return exports.SOLEND_RESERVES[f].address === address; });
    if (key) {
        return exports.SOLEND_RESERVES[key];
    }
    else {
        undefined;
    }
};
exports.getSolendReserveByAddress = getSolendReserveByAddress;
