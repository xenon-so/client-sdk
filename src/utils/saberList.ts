...
export interface Saber_LP {
  id: string;
  name: string;
  logoURI: string;
  tokens: Token[];
  tokenIcons: Token[];
  underlyingIcons: Token[];
  currency: string;
  lpToken: LP_token;
  plotKey: string;
  swap: {
...
const devnetLpList: Saber_LP[] = [
  {
    id: 'usdc_usdt',
    name: 'USDC-USDT',
    logoURI:
      'https://raw.githubusercontent.com/saber-hq/saber-lp-token-list/master/assets/devnet/YakofBo4X3zMxa823THQJwZ8QeoU8pxPdFdxJs7JW57/icon.png',
    tokens: [
      {
        symbol: 'USDC',
        name: 'USD Coin (Saber Devnet)',
        logoURI:
          'https://cdn.jsdelivr.net/gh/saber-hq/spl-token-icons@master/icons/103/2tWC4JAdL4AxEFJySziYJfsAnW2MHKRo98vbAPiRDSk8.png',
      ...
      },
      {
        ...
        logoURI:
          'https://cdn.jsdelivr.net/gh/saber-hq/spl-token-icons@master/icons/103/EJwZgeZrdC8TXTQbQBoL6bfuAnFUUy1PVCMB4DYPzVaS.svg',
...
export const mainnetLpList: Saber_LP[] = [
  {
    id: 'usdc_usdt',
    name: 'USDT-USDC',
    logoURI:
      'https://raw.githubusercontent.com/saber-hq/saber-lp-token-list/master/assets/mainnet/2poo1w1DL6yd2WNTCnNTzDqkC6MBXq7axo77P16yrBuf/icon.png',
    tokens: [
      {
        name: 'USD Coin',
        symbol: 'USDC',
        logoURI:
          'https://cdn.jsdelivr.net/gh/saber-hq/spl-token-icons@master/icons/101/EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v.png',
        decimals: 6,
    ...
    lpToken: {
      ...
      logoURI:
        'https://cdn.jsdelivr.net/gh/saber-hq/spl-token-icons@master/icons/101/2poo1w1DL6yd2WNTCnNTzDqkC6MBXq7axo77P16yrBuf.png',
      decimals: 6,
  ...
  },
  {
    ...
    name: 'cUSDC-cUSDT',
    logoURI:
      'https://raw.githubusercontent.com/saber-hq/saber-lp-token-list/master/assets/mainnet/SUSeGZEV69Xy7rQfhDffyTysHgEP3nJUDMxEZJSvJr1/icon.png',
    tokens: [
      {
        name: 'Solend USDC',
        symbol: 'cUSDC',
        logoURI:
          'https://cdn.jsdelivr.net/gh/saber-hq/spl-token-icons@master/icons/101/993dVFL2uXWYeoXuEBFXR4BijeXdTv4s6BzsCjJZuwqk.png',
        decimals: 6,
      ...
      },
      {
        ...
        symbol: 'cUSDT',
        logoURI:
          'https://cdn.jsdelivr.net/gh/saber-hq/spl-token-icons@master/icons/101/BTsbZDV7aCMRJ3VNy9ygV4Q2UeEo9GpR8D6VvmMZzNr8.png',
        decimals: 6,
    ...
    lpToken: {
      ...
      logoURI:
        'https://cdn.jsdelivr.net/gh/saber-hq/spl-token-icons@master/icons/101/SUSeGZEV69Xy7rQfhDffyTysHgEP3nJUDMxEZJSvJr1.png',
      decimals: 6,
  ...
  },
  {
    ...
    name: 'cSOL-cmSOL',
    logoURI:
      'https://cdn.jsdelivr.net/gh/saber-hq/spl-token-icons@master/icons/101/5h6ssFpeDeRbzsEHDbTQNH7nVGgsKrZydxdSTnLm6QdV.png',
    tokens: [
      {
        name: 'Solend SOL',
        symbol: 'cSOL',
      ...
      },
      {
        ...
        symbol: 'cmSOL',
        logoURI:
          'https://cdn.jsdelivr.net/gh/saber-hq/spl-token-icons@master/icons/101/3JFC4cB56Er45nWVe29Bhnn5GnwQzSmHVf6eUq9ac91h.png',
        decimals: 9,
    ...
    lpToken: {
      ...
      logoURI:
        'https://cdn.jsdelivr.net/gh/saber-hq/spl-token-icons@master/icons/101/SSoxcNry3qU1wN5Vj6zMJKTSqJPyPLks5KNfCJCmUPa.png',
      decimals: 9,
...
export const SABER_LP_LIST: Saber_LP[] = isMainnet
  ? mainnetLpList
  : devnetLpList;
